...
import PopupForm from '../about-update/about-update-form.jsx';
import Form from '../About-Form/about-form.jsx';
...
useEffect(() => {
    axios(`${baseUrl}/${componentUrl}`).then((res) => setData(res.data.data.image));
}, []);
...
{
isPopupOpen&& (
 <PopupForm isOpen={isPopupOpen} onClose={closePopup} id={editId} url={componentUrl} />)
}
{ 
isformPopupOpen&& (
