...
import PopupForm from '../contact-update/index.jsx';
import Form from '../contact-create/index.jsx';
...
return (
   ...
   <button className='create-button' onClick={() => openformPopup()}>Create {SectionName}</button>
